...
>
> This package continues as **`naf/form`**:
> [github.com/nafphp/form](https://github.com/nafphp/form) ·
...
> releases; `nixphp/form` stays on Packagist so existing installations keep working.
>
